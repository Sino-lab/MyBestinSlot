...
const I18N: Record<Lang, Record<string, string>> = {
  en: {
    nav_all: 'All BiS', nav_reco: 'Recommendations', nav_mylist: 'My List', nav_guild: 'Guild Loots',
    ...
    guild_title: 'Guild Loots', loots_recv: 'Loots', bis_drops: 'BiS drops',
  ...
  fr: {
    nav_all: 'Tous les BiS', nav_reco: 'Recommandations', nav_mylist: 'Ma Liste', nav_guild: 'Loots Guilde',
    ...
    guild_title: 'Loots de Guilde', loots_recv: 'Loots', bis_drops: 'Drops BiS',
